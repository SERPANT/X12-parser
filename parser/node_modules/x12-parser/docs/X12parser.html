...
<head>
    <meta charset="utf-8">
    <title>Class: X12parser | X12 EDI Parser</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>X12parser<span class="signature">(defaultEncoding)</span><span class="type-signature"></span></h2>
...
<dt>
        ...
        <h4 class="name" id="X12parser">
            
                new <span class="type-signature"></span>X12parser<span class="signature">(defaultEncoding)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="X12parser.js.html">X12parser.js</a></code>,
                <code><a href="X12parser.js.html#line10">line 10</a></code>
            </div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>defaultEncoding</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The encoding of the file</td>
        </tr>
...
<dt>
        ...
        <h4 class="name" id=".detectDelimiters">
            
                <span class="type-signature"><span class="icon green">static</span> </span>detectDelimiters<span class="signature">(data)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="X12parser.js.html">X12parser.js</a></code>,
                <code><a href="X12parser.js.html#line63">line 63</a></code>
            </div>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The first string in the fileTODO: Add additional validations here</td>
        </tr>
...
<dt>
        ...
        <h4 class="name" id="_flush">
            
                <span class="type-signature"></span>_flush<span class="signature">(cb)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="X12parser.js.html">X12parser.js</a></code>,
                <code><a href="X12parser.js.html#line27">line 27</a></code>
            </div>
...
<span class="param-type">function</span>
            ...
            <td class="description last">Execute cb when done flushing</td>
        </tr>
...
<dt>
        ...
        <h4 class="name" id="_transform">
            
                <span class="type-signature"></span>_transform<span class="signature">(chunk, encoding, cb)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="X12parser.js.html">X12parser.js</a></code>,
                <code><a href="X12parser.js.html#line40">line 40</a></code>
            </div>
...
<span class="param-type">object</span>
            ...
            <td class="description last">The next chunk of data from read stream</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The encoding of the chunk (e.g. UTF-8)</td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">Callback indicating chunk was processed and ready for next chunk</td>
        </tr>
...
<dt>
        ...
        <h4 class="name" id="generateSegments">
            
                <span class="type-signature"></span>generateSegments<span class="signature">(segments)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="X12parser.js.html">X12parser.js</a></code>,
                <code><a href="X12parser.js.html#line51">line 51</a></code>
            </div>
...
<span class="param-type">Array.&lt;object></span>
            ...
            <td class="description last">The array of segments to be pushed down the stream</td>
        </tr>
...
<dt>
        ...
        <h4 class="name" id="processChunk">
            
                <span class="type-signature"></span>processChunk<span class="signature">(chunk)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="X12parser.js.html">X12parser.js</a></code>,
                <code><a href="X12parser.js.html#line102">line 102</a></code>
            </div>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The chunk from a read stream</td>
        </tr>
...
<dt>
        ...
        <h4 class="name" id="removeDelimiters">
            
                <span class="type-signature"></span>removeDelimiters<span class="signature">(chunk)</span><span class="type-signature"> &rarr; {string}</span>
                
            
            <div class="container-source members">
                <code><a href="X12parser.js.html">X12parser.js</a></code>,
                <code><a href="X12parser.js.html#line77">line 77</a></code>
            </div>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The raw string for from read stream</td>
        </tr>
...
- String with delimiters removed
...
<dt>
        ...
        <h4 class="name" id="splitSegments">
            
                <span class="type-signature"></span>splitSegments<span class="signature">(rawString)</span><span class="type-signature"> &rarr; {Array.&lt;string>}</span>
                
            
            <div class="container-source members">
                <code><a href="X12parser.js.html">X12parser.js</a></code>,
                <code><a href="X12parser.js.html#line94">line 94</a></code>
            </div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>rawString</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Full segment string from EDI file</td>
        </tr>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'X12parser_sub'.replace(/"/g, '_');
