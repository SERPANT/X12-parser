...
<head>
    <meta charset="utf-8">
    <title>Class: Schema | X12 EDI Parser</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>Schema<span class="signature">(version, groups, defaultSchema)</span><span class="type-signature"></span></h2>
...
<dt>
        ...
        <h4 class="name" id="Schema">
                ...
                new <span class="type-signature"></span>Schema<span class="signature">(version, groups, defaultSchema)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="Schema.js.html">Schema.js</a></code>,
                <code><a href="Schema.js.html#line8">line 8</a></code>
            </div>
...
<span class="param-type">string</span>
            ...
            <td class="description last">What transaction version this applies to</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">JSON schema of groupings</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>defaultSchema</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">Indicates if this will be used if no schemas match transaction version</td>
        </tr>
...
<h4 class="name" id="default">
    <span class="type-signature"></span>default<span class="type-signature"> :boolean</span>
    
    <div class="container-source members">
        <code><a href="Schema.js.html">Schema.js</a></code>,
        <code><a href="Schema.js.html#line28">line 28</a></code>
    </div>
...
<dt>
<h4 class="name" id="schema">
    <span class="type-signature"></span>schema<span class="type-signature"> :object</span>
    
    <div class="container-source members">
        <code><a href="Schema.js.html">Schema.js</a></code>,
        <code><a href="Schema.js.html#line23">line 23</a></code>
    </div>
...
<h4 class="name" id="version">
    ...
    <div class="container-source members">
        <code><a href="Schema.js.html">Schema.js</a></code>,
        <code><a href="Schema.js.html#line18">line 18</a></code>
    </div>
...
<dt>
        ...
        <h4 class="name" id=".verifySchema">
            
                <span class="type-signature"><span class="icon green">static</span> </span>verifySchema<span class="signature">(schema)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="Schema.js.html">Schema.js</a></code>,
                <code><a href="Schema.js.html#line37">line 37</a></code>
            </div>
...
<span class="param-type"><a href="Schema.html">Schema</a></span>
            ...
            <td class="description last">The schema to be verified</td>
        </tr>
...
<dl>
    <dt>
        ...
        Throws an error if this is an invalid schema
        </div>
    </dt>
    <dd></dd>
    <dt>
